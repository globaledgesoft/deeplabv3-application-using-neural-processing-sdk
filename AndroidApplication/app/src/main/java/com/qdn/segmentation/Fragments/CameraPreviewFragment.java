...
import com.qdn.segmentation.Helpers.AutoFitTextureView;
...
import static com.qdn.segmentation.Utils.Constants.BUNDLE_KEY_IMAGE;
import static com.qdn.segmentation.Utils.Constants.REQUEST_CAMERA_PERMISSION;
...
public class CameraPreviewFragment extends Fragment
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // coordinate.
                int displayRotation = Surface.ROTATION_90;//activity.getWindowManager().getDefaultDisplay().getRotation();
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    Logger.d(TAG, mFile.toString());
                    unlockFocus();
                    goToSegmentedImageFragment();
    ...
    public void goToSegmentedImageFragment() {
        String stringUri = mFile.getAbsolutePath();
        Bundle args = new Bundle();
        args.putString(BUNDLE_KEY_IMAGE, stringUri);
        Fragment fragment = new ImageSegmentationFragment();
